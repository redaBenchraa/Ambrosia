...
class UserService(
    ...
    private final val keycloakService: KeycloakService
    private final val environmentProperties: EnvironmentProperties
    ...
    fun updateRoles(user: KeycloakUser) {
        ...
        if (Objects.isNull(currentUser)) {
            throw KeycloakException("error.keycloak.user_not_found")
        }
