...
class MenuMapperTest {
    ...
    fun `Get menu categories list`() {
        val business = Business("name", "phoneNumber", "email")
        val item1 = Item(name = "item1", price = 10.0, business = business).apply { id = 1 }
        val item2 = Item(name = "item2", price = 10.0, business = business).apply { id = 2 }
        val item3 = Item(name = "item3", price = 10.0, business = business).apply { id = 3 }
        val item4 = Item(name = "item4", price = 10.0, business = business).apply { id = 4 }
        val category1 = Category(name = "category1", business = business).apply { id = 5 }
        val category2 = Category(name = "category2", business = business).apply { id = 6 }
        val category3 = Category(name = "category3", business = business).apply { id = 7 }
        val menu = Menu(
            name = "name",
            price = 10.0,
            business = business
        ).apply { id = 8 }
        val menuItems = mutableSetOf(
            MenuItem(item = item1, category = category1, extra = 10.0, menu = menu).apply { id = 9 },
            MenuItem(item = item2, category = category2, menu = menu).apply { id = 10 },
            MenuItem(item = item3, category = category3, menu = menu).apply { id = 11 },
            MenuItem(item = item4, category = category3, menu = menu).apply { id = 12 },
        )
